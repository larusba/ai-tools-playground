...
1.  [**Standard Server (`neo4j-mcp`)**](./interactive_main.py): Provides out-of-the-box tools for schema exploration and basic read/write operations.
2.  [**Custom Server (`my_advanced_tools.py`)**](./my_advanced_tools.py): Implements custom logic (e.g., GraphRAG, Vector Search, complex traversals) using `FastMCP`.
